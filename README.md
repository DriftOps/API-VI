...
| 12   | Média      | Como paciente, quero criar planos alimentares (café da manhã, almoço, e jantar) de acordo com os meus dados nutricionais e  objetivos, para ter uma visão organizada da minha rotina.                                                                							| 13         | 3      | Estrutura de planos alimentares definida. Fórmula de cálculo validada. UI de rotina pronta                        					 |
| 13   | Baixa      | Como paciente, quero poder exportar ou baixar o histórico das minhas conversas em formato de texto, para guardar ou compartilhar minhas recomendações nutricionais.                                                                                                           | 8          | 3      | Formato de exportação definido. Estrutura de histórico criada. Critérios de segurança de dados prontos.                              |
| 14   | Baixa      | Como paciente, quero uma interface de ajuda para esclarecimento de dúvidas em relação ao uso da aplicação.                                                                                                                                                                    | 5          | 3      | Estrutura de FAQ definida. Links de ajuda preparados. UI dedicada planejada.                                                         |
